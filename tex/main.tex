...
\newcommand{\versuch}{Quantum Hall Effect} % Name des Versuchs
...
\newcommand{\betreuer}{Li, Quili}      % Name des zuständigen Betreuers
\newcommand{\durchgefuehrt}{03.05.2021}      % Datum, an dem der Versuch 
                                           % durchgeführt wurde
...
\begin{document}
    ...
    % Contents
    \MainMatter
    \input{./chap/ExperimentalSetup.tex}
